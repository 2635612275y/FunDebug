        ...
        <div class="settingDashboardViewTags">
            <ul>
                ...
                <li class="ng-scope">
                    ...
                    <div class="SettingType ng-binding"><a href="team.jsp">当前团队</a></div>
                </li>
                <li class="ng-scope">
...
<%--                                添加团队信息Servlet--%>
                                <form action="AccountTeamDateServlet?type=add" method="post">
                                    <div class="SettingTitle">团队名</div>
                                    <input type="text" class="SettingInput InputUser" name="name">

                                    <div class="SettingTitle">团队简称</div>
                                    <input type="text" class="SettingInput InputShort" name="short">

                                    <div class="SettingTitle">团队人数</div>
                                    <input type="text" class="SettingInput InputNumber" name="number">

                                    <div class="SettingTitle">团队长名字</div>
                                    <input type="text" class="SettingInput InputCaptain" name="captain">

                                    <div class="SettingTitle">创建日期</div>
                                    <input type="text" class="SettingInput InputDate" name="date" value="">
