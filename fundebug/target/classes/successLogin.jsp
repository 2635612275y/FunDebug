        ...
        <div class="right-menu">
            ...
            <ul class="nav">
                ...
                <li class="success-login">
                    ...
                    <ul class="success-login-type">
                        <li><a href="./setup.jsp">设置</a></li>
                        <li><a href="./fundebug.jsp">登出</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="container-bug">
        <div class="container-max">
            ...
            <div class="video-player">
                <div class="content">
                    <video style="outline: none" width="455" height="298" poster="https://www.fundebug.com/assets/images/landing/letter.9691f260.png" controls>
