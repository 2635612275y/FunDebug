 ...
 * @description:
 * @author: xfb
 * @time: 2020/12/26 8:57
 */
public class DBUtils {
    public static Connection getConnection() throws Exception {

        final  String driver = "com.mysql.jdbc.Driver";
        final  String url = "jdbc:mysql://localhost:3306/fundebug?user=root&password=womenzhijian&serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=UTF-8";
        Connection conn;
        // 取得数据库连接
        try {
            // 加载驱动程序
